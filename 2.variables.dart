...
void main() {
  ...
  // มันจะ check value ของทางขวามือเอง ว่าจะเป็นอะไร
  var firstname = 'Thun';
  final age = 30;
  const status = true;
  ...
  // เปลี่ยน value ของ firstname (var)
  firstname = 'Johny';
  print(firstname);
  ...
  print("Next year my age is ${age+1}"); //ถ้ามี function ทำงานในคำสั่ง print 
  print("Today is ${DateTime.now()}"); //built-in function
